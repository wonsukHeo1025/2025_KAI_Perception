...
def generate_launch_description():
    ...
    # Single-camera IoU fusion node
    single_iou_fusion_node = Node(
        package='calico',
        executable='single_iou_fusion_node',
        name='calico_single_iou_fusion',
        output='screen',
        parameters=[{
