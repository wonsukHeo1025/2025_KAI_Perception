...
// ament_index for package share lookup
...
public:
    PrismColorNode() : Node("prism_color_node") {
        ...
        // Use package config directory - user places calibration files here manually
        auto package_share_dir = ament_index_cpp::get_package_share_directory("prism");
        cal_config.calibration_directory = (std::filesystem::path(package_share_dir) / "config").string();
